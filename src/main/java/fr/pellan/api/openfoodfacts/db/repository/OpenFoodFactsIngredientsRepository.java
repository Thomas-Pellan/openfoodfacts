...
public interface OpenFoodFactsIngredientsRepository extends CrudRepository<OpenFoodFactsIngredientEntity, Integer> {
    ...
    @Query(value = "SELECT i FROM OpenFoodFactsIngredientEntity i WHERE i.openFoodFactsId = :openffId")
    OpenFoodFactsIngredientEntity findByOpenFFId(String openffId);
}
